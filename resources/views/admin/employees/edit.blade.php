...
@section('content')
    <div class="card card-info col-6" >
        ...
        <div class="">
            <form action="{{route('admin.employees.update',['employees'=>$data->id])}}" method="post">
                @csrf
                @method('PUT')
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control" name="repassword" id="repassword" placeholder="Nhập lại mật khẩu" value="{{$data->password}}">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-lock"></span>
                        </div>
